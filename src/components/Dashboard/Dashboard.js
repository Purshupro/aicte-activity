...
export default function Dashboard() {
  return (
    <div className="cardsContainer dashboardContainer">
      ...
      <Card className="events_card"><h3>FIT INDIA VIRTUAL RUN 2.0</h3> <Link to="/single-event/2"><Button disableElevation size="small" variant="contained">View Details</Button></Link></Card>
      <Card className="events_card"><h3>AZADI KA AMRIT MAHOTSAV</h3> <Link to="/single-event/3"><Button disableElevation size="small" variant="contained">View Details</Button></Link></Card>
    </div>
  );
}